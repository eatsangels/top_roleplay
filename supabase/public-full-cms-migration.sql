...
with seed(section_key, key, content_type, title, subtitle, body, href, media_url, media_type, icon, sort_order, data) as (
  ...
  ('character_paths', 'argent_police_force', 'path', 'Argent Police Force', null, 'Patrulla zonas calientes, investiga, arresta criminales y dirige redadas para mantener el orden.', null, null, null, 'Shield', 10, '{}'::jsonb),
  ('character_paths', 'sea_shadow_syndicate', 'path', 'Sea Shadow Syndicate', null, 'Mueve contrabando por rutas ocultas y golpea desde las sombras sin dejar rastro.', null, null, null, 'Skull', 20, '{}'::jsonb),
  ('character_paths', 'abyssal_reavers', 'path', 'Abyssal Reavers', null, 'Saqueadores despiadados: asalta territorios, siembra el caos y toma lo que quieras por la fuerza.', null, null, null, 'Skull', 30, '{}'::jsonb),
  ('character_paths', 'crimson_tide_outlaws', 'path', 'Crimson Tide Outlaws', null, 'Forajidos sanguinarios que imponen su ley a sangre y fuego en cada esquina de la ciudad.', null, null, null, 'Skull', 40, '{}'::jsonb),
  ('character_paths', 'iron_skull_brotherhood', 'path', 'Iron Skull Brotherhood', null, 'Hermandad brutal y disciplinada que conquista zonas y no perdona a quien se cruce en su camino.', null, null, null, 'Skull', 50, '{}'::jsonb),
  ('character_paths', 'civil_comerciante', 'path', 'Civil y Comerciante', null, 'Trabaja, comercia, transporta y prospera sin entrar en la guerra... todavía.', null, null, null, 'Anchor', 60, '{}'::jsonb),
