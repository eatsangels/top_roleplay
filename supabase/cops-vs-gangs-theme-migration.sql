...
with themed(section_key, key, title, subtitle, body, icon, data) as (
  values
    ...
    ('character_paths', 'pirata', 'Policía', null, 'Protege distritos, investiga delitos, ejecuta redadas y asciende dentro de la fuerza.', 'Shield', '{}'::jsonb),
    ('character_paths', 'mercenario', 'Banda Roja', null, 'Construye reputación criminal, controla territorios y compite por el dominio de la ciudad.', 'Skull', '{}'::jsonb),
    ('character_paths', 'comerciante', 'Banda Azul', null, 'Organiza operaciones, defiende tu zona y disputa los recursos más valiosos.', 'Swords', '{}'::jsonb),
    ('character_paths', 'marinero', 'Civil y Comerciante', null, 'Crea negocios, genera empleo y prospera entre facciones sin abandonar tu independencia.', 'Users', '{}'::jsonb),
    ('character_paths', 'cazador_de_tesoros', 'Informante', null, 'Convierte rumores e inteligencia en poder, protección o dinero.', 'MessageCircle', '{}'::jsonb),
    ('character_paths', 'capitan_de_clan', 'Transportista', null, 'Mueve recursos legales o clandestinos y decide cuánto riesgo estás dispuesto a aceptar.', 'Map', '{}'::jsonb),
