...
with themed(section_key, key, title, subtitle, body, icon, data) as (
  values
    ...
    ('character_paths', 'argent_police_force', 'Argent Police Force', null, 'Patrulla zonas calientes, investiga, arresta criminales y dirige redadas para mantener el orden.', 'Shield', '{}'::jsonb),
    ('character_paths', 'sea_shadow_syndicate', 'Sea Shadow Syndicate', null, 'Mueve contrabando por rutas ocultas y golpea desde las sombras sin dejar rastro.', 'Skull', '{}'::jsonb),
    ('character_paths', 'abyssal_reavers', 'Abyssal Reavers', null, 'Saqueadores despiadados: asalta territorios, siembra el caos y toma lo que quieras por la fuerza.', 'Swords', '{}'::jsonb),
    ('character_paths', 'crimson_tide_outlaws', 'Crimson Tide Outlaws', null, 'Forajidos sanguinarios que imponen su ley a sangre y fuego en cada esquina de la ciudad.', 'Skull', '{}'::jsonb),
    ('character_paths', 'iron_skull_brotherhood', 'Iron Skull Brotherhood', null, 'Hermandad brutal y disciplinada que conquista zonas y no perdona a quien se cruce en su camino.', 'Swords', '{}'::jsonb),
    ('character_paths', 'civil_comerciante', 'Civil y Comerciante', null, 'Trabaja, comercia, transporta y prospera sin entrar en la guerra... todavía.', 'Users', '{}'::jsonb),
